...
st.session_state['agent_created_files_folder'] = f"{st.session_state['curr_dir']}/agent_created_files"
    ...
    if prompt != '':
        with get_openai_callback() as cb:
            ...
            if st.session_state['agent'] is not None:
                ...
                prompt_template = f"""put the following data into a pandas dataframe, then save it into a csv file {st.session_state['agent_created_file_location']}, note you need to escape the backslashes in the file path, no need to check if file is created.
                                    data:
                                    {st.session_state['query_result']}
                                    """
